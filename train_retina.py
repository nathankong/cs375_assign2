...
# THERE ARE TYPOS IN THIS VERSION OF ln(). THE OTHER FILE WITH HAVE THE CORRECT ln() IMPLEMENTATION.
...
def poisson_loss(logits, labels):
    ...
    #return 1.0/(logits.get_shape().as_list()[1]) * tf.reduce_sum(logits - labels * tf.log(logits + epsilon), 1)
